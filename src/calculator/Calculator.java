...
/**
 * To write a program to do aritmetic operations for the input array read from the user.
 *
...
public class Calculator {
    public static void main(String[] args) {
        ...
        System.out.println("How many number you want to operate?");
        int totalNumbers = scanner.nextInt();
        float[] inputArray = new float[totalNumbers]; //Paneb numbrid arraysse, float kuna eelnevalt oli ka. Total numbers annab useri inputi alusel palju numbreid on.
